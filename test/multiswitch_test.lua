...
local List=require'multi_reverse/multiswitch'
TestList={}
...
function TestList:test_map()
	...
	lu.assertEquals(l1:map(function(elm) return {elm ,elm} end  ) , {{1,1},{2,2},{3,3},{4,4},_index=1} )
...
function TestList:test_map_with_index()
	...
	lu.assertEquals(l1:map_with_index(function(elm,i) return (i & 1)== 1  and elm end ) ,{1,false,3,false,_index=1} )
	lu.assertEquals(l1:map(function(elm) return {elm ,elm} end  ) , {{1,1},{2,2},{3,3},{4,4},_index=1} )
